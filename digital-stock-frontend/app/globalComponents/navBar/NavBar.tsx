export default function NavBar() {
  return (
    ...
    <div className="left-10 absolute z-50 flex px-4 py-2 rounded-sm max-lg:hidden">
    <div className="flex flex-wrap  px-10 py-3 relative">
        <div
          id="collapseMenu"
        ...
        >
          ...
          >
            <svg className="w-4 fill-black" viewBox="0 0 320.591 320.591">
              <path
        ...
        <div className="absolute w-80 z-50 bg-gray-100 flex px-4 py-2 rounded-sm max-lg:hidden">
          <svg
            xmlns="http://www.w3.org/2000/svg"
