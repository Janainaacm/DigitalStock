        ...
        >
          <ul className="space-y-2">
            <li>
              ...
              >
                <svg className="h-5 w-5 mr-2 text-gray-600"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="text-gray-800 text-sm flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all"
                >
                  <svg className="w-5 h-5 mr-3"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.4" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  
