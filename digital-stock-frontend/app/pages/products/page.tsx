           ...
           <div className="relative w-full aspect-w-16 p-2 aspect-h-8 lg:h-80">
             ...
             >
                ...
                className={`text-red-600 ${
                    isInWishlist(product.id) ? "fill-red-600" : "fill-none hover:fill-red-200 hover:scale-[1.05] hover:opacity-80 transition-all duration-600"
                  }`}
                viewBox="0 0 24 24" 
                stroke="currentColor">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 flex items-center flex-wrap gap-2">
                <h4 className="text-md font-semibold text-gray-800">${product.price}</h4>
