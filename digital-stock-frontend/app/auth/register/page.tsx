  ...
  return (
    <div className="font-[sans-serif] bg-white max-w-7xl flex items-center mx-auto min-h-screen p-4">
      <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        ...
        <form className="md:col-span-2 w-full py-10 sm:px-16">
          <div className="mb-7">
            <h3 className="text-gray-800 text-3xl py-6 font-bold">Create an account</h3>
          </div>
          ...
          <div className="space-y-10">
            <div>
              <div className="relative flex items-center">
                ...
                type="text" 
                required 
                className="w-full text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none hover:border-black-600 transition-all duration 400" 
            ...
            <div className="flex items-center pt-3">
              <input type="checkbox" className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
          ...
          <p className="text-gray-800 text-sm mt-6 text-center">Already have an account? <a href="./signin" className="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
        </form>
      </div>
    </div>
  );
